...
#Season
season <- 2015
weekNo <- 9   # Set weekNo = 0 for seasonal projections
...
recMultiplier <- 1          #1 pts per reception ### Changed from 0
recYdsMultiplier <- (1/10)  ##1 pt per 10 receiving yds ## Changed from 8
