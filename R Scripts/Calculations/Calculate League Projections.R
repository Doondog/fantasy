...
# Notes:
# To do:
#   1) Correct sourcesOfProjections workaround where i overwrote the variable with the only projections i had available
###########################
...
sourcesOfProjections <- c("CBS","ESPN") #####
sourcesOfProjectionsAbbreviation <- c("cbs",'espn')
